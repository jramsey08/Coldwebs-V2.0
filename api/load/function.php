...
<li><a href="/admin/Functions/<?php echo OtarEncrypt($Array,$FunctionId); ?>" target="function">Edit</a></li>
<li><a href="#">Copy</a></li>
<li><a href="#">Details</a></li>
<li class="divider"></li>
<li><a href="/Process/Delete/Functions/<?php echo OtarEncrypt($Array,$FunctionId); ?>" target="function">Remove</a></li>
</ul></div></td>
</tr><?php } ?>
