...
<title>Welcome | Please configure your new website</title>

<link href="api/welcome/styles/smart_wizard.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="api/welcome/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="api/welcome/js/jquery.smartWizard-2.0.min.js"></script>
...
<!-- Tabs -->
  		<div id="wizard" class="swMain">
  			<ul>
                ...
                <span class="stepDesc">
                   Welcome<br />
                   <small>Read your welcome message</small>
                </span>
            </a></li>
  			</ul>
  			<div id="step-1">	
            ...
            <table cellspacing="3" cellpadding="3" align="center">
  			...
  			<div id="step-4">
            <h2 class="StepTitle">Step 4: Welcome Message</h2>	
