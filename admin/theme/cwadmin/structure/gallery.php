...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND type='gallery' AND trash='0'"; 
...
<li><a href="/Process/Copy/Gallery/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Gallery'>
</form>
