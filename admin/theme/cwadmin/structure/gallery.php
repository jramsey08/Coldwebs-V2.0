            ...
            <div class="cl-mcont">
                <div class="page-head">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Website Gallery</li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="block-flat">
                            ...
                            <br>
                            <center>
                                <button type='submit' formaction="/Process/EditArticle/Delete" style="background-color: red; color: white;" class="btn btn-trans"><i class="fa fa-check"></i> Delete </button>
                                <button type='submit' formaction="/Process/EditArticle/Active" style="background-color: green; color: white;" class="btn btn-trans"><i class="fa fa-check"></i> Activate </button>
                                <button type='submit' formaction="/Process/EditArticle/Inactive" style="background-color: grey; color: white;" class="btn btn-trans"><i class="fa fa-check"></i> In-Active </button>
                            </center>
                            <div class="content">
                                <div class="table-responsive">
                                    ...
                                    <tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND type='post-gallery' AND trash='0' AND webid='$WebId'"; 
...
$row = CwOrganize($row,$Array);
$GalleryCount = 0;
$querY = "SELECT * FROM images WHERE album='$ArticleId' AND type='image' AND trash='0' AND webid='$WebId'"; 
$resulT = mysqli_query($CwDb,$querY);
                                                ...
                                                <td class="center"> 
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="/admin/Gallery/<?php echo $ArticleId; ?>">Edit</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="/Process/Delete/Gallery/<?php echo $ArticleId; ?>">Remove</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
<?php } ?>									
        ...
        <input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Gallery'>
        </form>
    </div> 
</div>
