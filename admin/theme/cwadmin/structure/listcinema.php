...
<li><a href="#vids" data-toggle="tab">Videos</a></li>
...
<?php if($Article['id'] != ""){ ?>
<a href="http://<?php echo $SiteInfo['domain']; echo "/CwPreview/$Article[id]"; ?>" target="_blank" class="btn btn-default">Preview</a>
<?php }else{ ?>
...
<input type="hidden" name="imgtype" value="post-video">
