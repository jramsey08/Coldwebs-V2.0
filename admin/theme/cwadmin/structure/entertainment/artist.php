        ...
        <div class="cl-mcont">
            <div class="page-head">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Music Artists</li>
                </ol>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                ...
                                                <td class="center"> 
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="/admin/Artists/<?php echo $ArticleId; ?>">Edit</a></li>
...
<?php } ?>
        ...
        <input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Artists'>
    </form>
</div>
