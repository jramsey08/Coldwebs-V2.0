                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="block-flat">
                            ...
                            <br>
                            <center>
                                <button type='submit' formaction="/Process/EditAdmin/Delete" style="background-color: red; color: white;" class="btn btn-trans"><i class="fa "></i> Delete </button>
                                <button type='submit' formaction="/Process/EditAdmin/Active" style="background-color: green; color: white;" class="btn btn-trans"><i class="fa "></i> Activate </button>
                                <button type='submit' formaction="/Process/EditAdmin/Inactive" style="background-color: grey; color: white;" class="btn btn-trans"><i class="fa "></i> In-Active </button>
                            </center>
                            <div class="content">
...
<?php }} ?>
          	...
          	<input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Bg-Menu'>
      	</form>
	</div> 
</div>
...
function CwAutoSave(ListId){
    ...
    xhttp.open("GET", "<?php echo $Website_Url_Auth; ?>./api/cwautosave/request.php?id=" + ListId + "&type=bg-menu-list&list=" + List.value, true);
    xhttp.send();
}
</script>
       ...
       /* Formating function for row details */
        function fnFormatDetails ( oTable, nTr )
        {
            function GetBgListChild(callback){
                var data;
                $.ajax({
                    url: '<?php echo "$Website_Url_Auth/admin/theme/cwadmin/extras/load.php?load=1" ?>',
                    data: '',
