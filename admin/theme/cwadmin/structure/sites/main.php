        <div class="cl-mcont">
            ...
            <div class="page-head">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Hosted Websites</li>
                </ol>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-flat">
                        ...
                        <center>
                            <button type='submit' formaction="/Process/SiteSwitch/Active" style="background-color: green; color: white;" class="btn btn-trans"><i class="fa "></i> Manage Website </button>
                        </center>
...
?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="/admin/HostedSites/<?php echo $ArticleId; ?>">Edit</a></td>
                                            </tr>
<?php } ?>
                                        </tbody>
                                    </table>							
                            ...
                            <input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/HostedSites'>
                        </form>
                    </div>				
                </div>
            </div>
