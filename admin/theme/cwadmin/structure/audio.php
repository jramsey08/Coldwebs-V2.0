...
<li class="active">Website Audio</li>
</ol></div>
...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND type='album' AND trash='0'"; 
...
<li><a href="/admin/Audio/<?php echo $ArticleId; ?>">Edit</a></li>
<li><a href="/Process/Copy/Audio/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Audio'>
</form>
