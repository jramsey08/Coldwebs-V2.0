          ...
          <ul class="cl-vnavigation">
            ...
            <li><a href="#"><i class="fa fa-envelope nav-icon"></i><span>Email</span></a>
              <ul class="sub-menu">
                ...
                <li class="active" ><a href="email-compose.html"><span class="label label-primary pull-right">New</span>Email Compose</a></li>
              </ul>
            </li>
      ...
      <div class="">
        ...
        <div class="mail-nav collapse">
          <ul class="nav nav-pills nav-stacked ">
            <li class="active"><a href="?p=email-inbox"><span class="label label-primary pull-right">6</span><i class="fa fa-inbox"></i> Inbox</a></li>
