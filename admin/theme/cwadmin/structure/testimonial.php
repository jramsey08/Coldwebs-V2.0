...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category='self' AND type='review' AND trash='0' AND webid='$WebId'";
...
<li><a href="/admin/Testimonial/<?php echo $ArticleId; ?>">Edit</a></li>
</ul></div></td>
</tr>
<?php } ?>									
</tbody>
...
<input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth/admin/$Get[url]"; ?>'>
</form>
