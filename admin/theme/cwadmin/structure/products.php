...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND category!='' AND type='product' AND trash='0'"; 
...
<td><?php echo $Row['content']['prodprice']; ?></td>
<td class="center"> 
<div class="btn-group">
...
<li><a href="/admin/Products/<?php echo $ArticleId; ?>">Edit</a></li>
<li><a href="/Process/Copy/Product/<?php echo $ArticleId; ?>">Copy</a></li>
<li class="divider"></li>
