...
<h3>Website Articles
<div align="right">
<button type="button" onclick="window.location.href='/admin/<?php echo $_GET['type']; ?>/New'" class="btn btn-flat"><i class="fa fa-check"></i> Create New</button>
</div>
</h3>			
</div><br>
...
<li><a href="/Process/Copy/Article/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Trash/Articles'>
</form>
