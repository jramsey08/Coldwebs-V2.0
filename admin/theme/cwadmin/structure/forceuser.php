...
<div class="col-sm-6">
<input type="text" name='name' placeholder="Enter First and Last Name" class="form-control" value='<?php echo $ListedUser['name']; ?>' disabled>
</div></div><br><br>
<div class="form-group">
...
<div class="col-sm-6">
<input type="text" name='email' placeholder="Enter E-Mail Address" class="form-control" value='<?php echo $ListedUser['email']; ?>' disabled>
</div></div><br><br>
<?php if($UserSiteAccess['grantaccess'] == "1"){ ?>
<div class="form-group">
<label class="col-sm-3 control-label">Account Type</label>
<div class="col-sm-6">
<select class="form-control" name='access' disabled>
...
$result = mysqli_query($CwDv,$query);
while($row = mysqli_fetch_assoc($result)){
$name = strtolower($row['name']);
$Social = $Article['other']['social']; ?>
<label class="col-sm-3 control-label"><?php echo $row['name']; ?></label>
