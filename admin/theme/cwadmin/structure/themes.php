...
<li class="active">Website Themes</li>
</ol></div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" onclick="window.location.href='./<?php echo $_GET['url']; ?>/Upload'" class="btn btn-flat"><i class="fa fa-check"></i> Upload New</button>
</h3>			
</div>
...
<li><a href="/admin/Design/<?php echo $TempId; ?>">Edit</a></li>
<li class="divider"></li>
<li><a href="/Process/Delete/Design/<?php echo $ArticleId; ?>">Remove</a></li>
</ul></div></td>
</tr>
<?php } ?>									
</tbody>
