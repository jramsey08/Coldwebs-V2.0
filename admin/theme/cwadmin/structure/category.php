...
<li class="active">Website Categories</li>
</ol></div>
...
<?php
$Count = "";
$Query = "SELECT * FROM articles WHERE category='self' AND type='category' AND trash='0'"; 
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Category'>
</form>
