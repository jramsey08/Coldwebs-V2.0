...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND category!='x' AND category!='' AND type='author' AND trash='0'"; 
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Author'>
</form>
