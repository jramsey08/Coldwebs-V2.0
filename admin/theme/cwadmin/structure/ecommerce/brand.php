...
<?php
$Count = "";
$Query = "SELECT * FROM cwoptions WHERE type='brand' AND trash='0' AND webid='$WebId'";
                                                ...
                                                <td class="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="/admin/Ecommerce-Brand/<?php echo $ArticleId; ?>">Edit</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
<?php } ?>
            ...
            <input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Ecommerce-Brand'>
        </form>
    </div> 
</div>
