                                                ...
                                                <td class="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="/admin/Ecommerce-Supplier/<?php echo $ArticleId; ?>">Edit</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
<?php } ?>
            ...
            <input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Ecommerce-Supplier'>
        </form>
    </div> 
</div>
