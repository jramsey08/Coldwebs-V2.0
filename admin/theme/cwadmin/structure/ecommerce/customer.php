                                                ...
                                                <td class="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="/admin/Ecommerce-Customer/<?php echo $UserId; ?>">Edit</a></li>
<?php if($UserSiteAccess['forceuser'] == "1"){ ?>
                                                            <li><a href="/admin/Ecommerce-Customer/<?php echo $UserId; ?>">Force</a></li>
            <?php } ?>
                                                        </ul>
                                                    </div>
                                                </td>
...
<?php }} ?>									
      		...
      		<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Ecommerce-Customer'>
        </form>
	</div>
</div>
