...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE type='post-product' AND trash='0' AND webid='$WebId'"; 
...
<input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Products'>
</form>
