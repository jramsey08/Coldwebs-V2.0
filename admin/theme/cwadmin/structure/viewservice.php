...
<th style="width:60%;"><strong>Url</strong></th>
...
<td style="width:10%;"><input type='text' name="ImageOrder[<?php echo $row['id']; ?>]" size="10" value='<?php echo $row["list"]; ?>'></td>
<td style="width:60%;"><input type='text' name="ImageUrl[<?php echo $row['id']; ?>]" size="80" value='<?php echo $row["url"]; ?>'></td>
...
<input type="hidden" name="imgtype" value="post-service">
