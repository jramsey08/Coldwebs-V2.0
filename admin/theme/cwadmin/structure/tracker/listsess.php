<div class="cl-mcont">
    <div class="page-head">
        <ol class="breadcrumb">
            ...
            <li class="active">Session Group <?php echo $PullSession['id']; ?></li>
        </ol>
    </div>
    <div class="row">		
                    ...
                    <div class="tab-pane active cont" id="basic">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['pagename']; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['page']; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <br><br>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Total LoadTime:</label>
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['loadtime']; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['mobile']; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">CMS LoadTime:</label>
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['tracker_load']["other"]["top"]; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Template LoadTime:</label>
                                        <div class="col-sm-9">
                                            <input type="text" name='name' placeholder="Info Not Reported" class="form-control" value='<?php echo $PullSession['tracker_load']["other"]["template"]; ?>' disabled>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="block-flat">
                                        <div class="content">
                                            <div class="header">
                                                <h3>Pages Visited in Current Session:</h3>
                                            </div>
...
?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center"><a href="/admin/Tracker/Session/<?php echo $ArticleId; ?>">View Details</a>
                                                            </td>
                                                        </tr>
<?php } ?>
                                                    </tbody>
