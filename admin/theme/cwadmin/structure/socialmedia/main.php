...
<div align="right">
<button type="button" onclick="window.location.href='./<?php echo $_GET['url']; ?>/New'" class="btn btn-flat"><i class="fa fa-check"></i> Link Account</button>
</div>
</h3>			
</div><br>
...
<center>
<button type='submit' formaction="/Process/EditSocial/Delete" style="background-color: red; color: white;" class="btn btn-trans"><i class="fa "></i> Delete </button>
</center>
...
<?php if($Row['active'] != "1"){ ?>
<td><a href="<?php echo "/Process/SocialAuth/$ArticleId"; ?>">Authenticate</a></td>
<?php }else{ ?>
