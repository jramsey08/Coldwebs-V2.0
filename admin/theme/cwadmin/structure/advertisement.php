...
<li><a href="/admin/Advertisement/<?php echo $ArticleId; ?>">Edit</a></li>
<li><a href="/Process/Copy/Advertisement/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
<li><a href="/Process/Delete/Advertisement/<?php echo $ArticleId; ?>">Remove</a></li>
</ul></div></td>
</tr>
<?php } ?>									
</tbody>
