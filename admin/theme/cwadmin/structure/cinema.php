...
<li class="active">Website Cinema</li>
</ol></div>
...
<center>
<button type='submit' formaction="/Process/EditArticle/Delete" style="background-color: red; color: white;" class="btn "><i class="fa "></i> Delete </button>
<button type='submit' formaction="/Process/EditArticle/Active" style="background-color: green; color: white;" class="btn "><i class="fa "></i> Activate </button>
<button type='submit' formaction="/Process/EditArticle/Inactive" style="background-color: grey; color: white;" class="btn "><i class="fa "></i> In-Active </button>
</center>
...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND type='video' AND trash='0'"; 
...
<li><a href="/admin/Cinema/<?php echo $ArticleId; ?>">Edit</a></li>
<li><a href="/Process/Copy/Cinema/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
<li><a href="/Process/Delete/Article/<?php echo $ArticleId; ?>">Remove</a></li>
</ul></div></td>
</tr>
<?php } ?>									
</tbody>
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Cinema'>
</form>
