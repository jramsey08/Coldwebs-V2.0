...
<tbody>
<?php
$Query = "SELECT * FROM articles WHERE category!='self' AND type='post-video' AND trash='0' AND webid='$WebId'"; 
...
<input type='hidden' name='redirect' value='<?php echo "http://$Website_Url_Auth"; ?>/admin/Cinema'>
</form>
