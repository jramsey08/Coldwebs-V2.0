...
<form name='edituser' id='edituser' method='post'><br>
<center>
<button type='submit' formaction="/Process/EditUser/Active" style="background-color: green; color: white;" class="btn btn-trans"><i class="fa "></i> Activate </button>
<button type='submit' formaction="/Process/EditUser/Limit" style="background-color: grey; color: white;" class="btn btn-trans"><i class="fa "></i> Limit </button>
<button type='submit' formaction="/Process/EditUser/Suspend" style="background-color: grey; color: white;" class="btn btn-trans"><i class="fa "></i> Suspend </button>
<button type='submit' formaction="/Process/EditUser/Delete" style="background-color: red; color: white;" class="btn btn-trans"><i class="fa "></i> Delete </button>
</center>
...
<td><center><img src="<?php echo $Img; ?>" height="50" width="50"></center></td>
...
<li><a href="/admin/Users/<?php echo $UserId; ?>">Edit</a></li>
<?php if($UserSiteAccess['forceuser'] == "1"){ ?>
<li><a href="/admin/Force/<?php echo $UserId; ?>">Force</a></li>
<?php } ?>
</ul></div></td>
</tr>
<?php }} ?>									
...
<input type='hidden' name='redirect' value='<?php echo $Array["siteinfo"]["domain"]; ?>/admin/Users'>
</form>
