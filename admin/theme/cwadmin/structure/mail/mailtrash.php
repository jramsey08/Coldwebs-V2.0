...
if($UserSiteAccess['adminmessages'] == "1"){
    $query = "SELECT * FROM messages WHERE admin='1' AND type='inbox' AND trash='1' AND user='!$Current_Admin_Id' AND webid='$WebId' 
    OR  admin='0' AND type='inbox'AND user='$Current_Admin_Id' AND trash='1' AND webid='$WebId' ORDER BY id DESC"; 
}else{
    $query = "SELECT * FROM messages WHERE admin='0' AND user='$Current_Admin_Id' AND type='inbox' AND trash='1' AND webid='$WebId' ORDER BY id DESC"; 
}
                        ...
                        <div class="item">
                            ...
                            <div>
                                <span class="date pull-right">
                                    ...
                                    <a href="/Process/Delete/Mail-Restore/<?php echo OtarEncrypt($key,$row[id]); ?>">
