...
<div class="mails">
<?php $query = "SELECT * FROM messages WHERE admin='1' AND user!='$Current_Admin_Id' AND trash='1' ORDER BY id DESC"; 
$result = mysql_query($query) or die(mysql_error());
while($row = mysql_fetch_array($result)){ ?>
<div class="item">
<div><input type="checkbox" name="c[<?php echo $row['id']; ?>]" /></div><div>
<span class="date pull-right"><i class="fa fa-paperclip"></i> <?php echo date("d-M-Y",$row['date']); ?></span>
