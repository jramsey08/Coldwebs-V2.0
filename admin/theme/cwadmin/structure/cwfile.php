...
<li class="active">CW File Manager</li>
</ol></div>
...
<li><a href="/admin/CwFile/<?php echo $ArticleId; ?>">Edit</a></li>
<li><a href="/Process/Copy/CwFile/<?php echo OtarEncrypt($key,$ArticleId); ?>">Copy</a></li>
<li class="divider"></li>
