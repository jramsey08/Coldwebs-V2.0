...
if($Check_New == ""){
    mysqli_query($CwDb,"INSERT INTO tracker_new (ipaddress, date, webid) VALUES('$TrackerIp', '$TrackerDate3', $WebId) "); 
}

if($Check_Submission == ""){
    mysqli_query($CwDb,"INSERT INTO tracker (session, ref,ipaddress, date, page, pagename, countrycode, country, state, city, zipcode, lat, lon, timezone, mobile, user, date2, date3, arrival, browser_platform, browser_version, browser_pattern, browser_useragent, browser_name, online, expire, admin, webid) 
