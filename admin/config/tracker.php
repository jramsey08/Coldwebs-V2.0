...
$query = "SELECT * FROM tracker WHERE date='$TrackerDate' AND ipaddress='$TrackerIp'"; 
...
if($Check_Submission == ""){
    mysql_query("INSERT INTO tracker (session, ref,ipaddress, date, page, pagename, countrycode, country, state, city, zipcode, lat, lon, timezone, mobile, user, date2, date3, arrival, browser_platform, browser_version, browser_pattern, browser_useragent, browser_name, online, expire, admin) VALUES('$Session_Id', '$Referer', '$TrackerIp', '$TrackerDate', '$TrackerPage', '$TrackerPageName', '$Tracker_Country_Code', '$Tracker_Country', '$Tracker_Region', '$Tracker_City', '$Tracker_Zipcode', '$Tracker_Latitude', '$Tracker_Longitude', '$Tracker_TimeZone', '$Tracker_Mobile', '$Tracker_User', '$TrackerDate2', '$TrackerDate3', '$TrackerDate4', '$Browser_Platform', '$Browser_Version', '$Browser_Pattern', '$Browser_User_Agent', '$Browser_Name', '1', '$time_check', '1') ") 
    or die(mysql_error());
    $AddHits = 1;
}
