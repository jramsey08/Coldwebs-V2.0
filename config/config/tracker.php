...
$TrackerDate = date("D M/j/Y G:i T Y");
$TrackerPage = "$_SERVER[REQUEST_URI]";
$TrackerPageName = $ActiveArticle['content'];
...
if($Check_New == ""){
    mysqli_query($CwDb,"INSERT INTO tracker_new (ipaddress, date, date2, webid) VALUES('$TrackerIp', '$TrackerDate3', '$TrackerDate2', '$WebId') ")
    or die(mysql_error());
}
